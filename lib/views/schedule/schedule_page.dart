    ...
    return GestureDetector(
      onTap: () {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Fitur Pemilihan Lokasi Sedang Dikembangkan')),
        );
      },
      child: Container(
        ...
        child: Row(
          ...
          children: const [
            ...
            Text(
              'Pilih Lokasi',
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color(0xFFAFEE00)), // Warna aksen hijau
            ),
          ],
        ),
      ),
